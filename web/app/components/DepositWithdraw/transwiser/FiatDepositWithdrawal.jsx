...
import DepositFiatOpenLedger from "./DepositFiat";
import WithdrawFiatOpenLedger from "./WithdrawFiat";

class FiatDepositWithdrawCurrency extends React.Component {
    static propTypes = {
...
class FiatDepositWithdrawal extends React.Component {
    static propTypes = {
...
export default BindToChainState(FiatDepositWithdrawal, {keep_updating:true});
