...
class GatewayDepositRequest extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        super(props);
        this.deposit_address_cache = new DepositAddressCache();
    ...
    requestDepositAddress() {
        ...
        fetch( TransConf.request_deposit_address_url, {
            method:'post',
        ...
        .catch( error => {
            notify.addNotification({
                message: `${counterpart.translate("gateway.generate_new_fail", {reason: error})}`,
                level: "error",
                autoDismiss: 10
            });
                    ...
                    <Modal id={withdraw_modal_id} overlay={true}>
                        ...
                        <div className="grid-block vertical">
                            <WithdrawModal
                                ...
                                asset={this.props.receive_asset.get('symbol')}
                                url={TransConf.validate_address_url}
...
export default BindToChainState(GatewayDepositRequest, {keep_updating:true});