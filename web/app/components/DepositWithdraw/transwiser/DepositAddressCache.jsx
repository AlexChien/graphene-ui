...
class DepositAddressCache {
    constructor()
    {
        ...
        this.current_address_cache_version_string = '1';

        //let wallet = WalletDb.getWallet();
        //delete wallet.deposit_keys["transwiser"];
        //WalletDb._updateWallet();
    }

    getIndexForDepositKeyInExchange(account_name, input_coin_type, output_coin_type)
    {
        let args = [this.current_address_cache_version_string, account_name, input_coin_type, output_coin_type];
...
export default DepositAddressCache;
